...
public class Live_demo_Sorted {
	...
	private static String getPriceVeggie(WebElement s) {
		...
		List<String> List_origin =  elements_List.stream().map(s->s.getText()).collect(Collectors.toList());
		
		List<String> sorted_List = List_origin.stream().sorted().collect(Collectors.toList());
		
		 Assert.assertTrue(List_origin.equals(sorted_List));*/
